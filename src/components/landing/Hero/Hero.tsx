    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 z-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Immerse yourself in the ultimate concert management platform. Find tickets, explore events, and experience music in a whole new dimension.
          </p>
        ...
        <div className="hidden md:block">
          <div className="absolute top-20 left-10 text-purple-500 opacity-20 text-6xl animate-float">♪</div>
          <div className="absolute top-40 right-20 text-fuchsia-500 opacity-20 text-5xl animate-float-delay">♫</div>
          <div className="absolute bottom-20 left-20 text-pink-500 opacity-20 text-7xl animate-float-delay-2">♩</div>
        </div>
      </div>
